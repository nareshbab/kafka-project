...
public class Application {
    ...
    public static Twitter getTwitterinstance() {
		...
		cb.setDebugEnabled(true)
		  .setOAuthConsumerKey("Baw6s1bPeODLPaUDOKr32PFd6")
		  .setOAuthConsumerSecret("mxfATysteInhidYTHWXmC1m45lrw4xFR4sTfeDfHqukIvq9zYT")
		  .setOAuthAccessToken("3060134244-B3thADkKhDuqcyZGq6LUvjmTQdgUO92PVGT5tKk")
		  .setOAuthAccessTokenSecret("gxTyTOOlSL39wTNLs2siuCME3PPuOVQVvu6a0TFMQqSrA");
